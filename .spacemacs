...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(html
     ...
     git
     ;; helm
     ;; Needed for atleast getting env vars on startup
     osx
     ivy
     lsp
     ;; markdown
